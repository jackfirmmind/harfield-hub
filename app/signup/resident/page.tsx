...
export default function Signup() {
  ...
  return (
    <div className="mx-auto max-w-[420px] px-5 py-14">
      <h1 className="h-display text-[2rem] mb-2">Create a resident account</h1>
      <p className="text-inkSoft mb-6 text-[0.95rem]">
        So you can save businesses and leave reviews.
      </p>
      ...
      <p className="text-[0.9rem] text-inkSoft mt-2">
        Run a business? <Link href="/join/apply">List it here</Link> instead.
      </p>
    </div>
  );
}
